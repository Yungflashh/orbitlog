...
Coinbase.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})
...
Cashapp.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})

TWOFA.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})
...
COINZOOM.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})
...
Dumps.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})
CPN.addEventListener("click", event => {
    const target = event.target.id;
    console.log(target)
    disappear(target);
})
...
function disappear(target){
    console.time();
    const array = ["Chase", "Coinbase", "Cashapp", "TWOFA", "COINZOOM", "Dumps", "CPN", "RDP", "WEB"];
